                ...
                return f
                  ...
                  .then(function (e) {
                    var t,
                      ...
                      e =
                        ((n.innerHTML = e),
                        n.querySelector(".js-yearly-contributions")),
                      o = (g(".position-relative h2", e).remove(), !0),
                      a = !1,
                      u = void 0;
                    try {
                      for (
                        var s, i = n.querySelectorAll("a")[Symbol.iterator]();
                        !(o = (s = i.next()).done);
                        o = !0
                      ) {
                        var c = s.value;
                    ...
                    e.querySelector("include-fragment")
                      ...
                      : (!0 === f.responsive &&
                          ...
                          n.setAttribute("viewBox", "0 0 " + a + " " + u)),
                        !1 !== f.global_stats &&
                          ((a = (n = p(g("svg", e).outerHTML)).current_streak
                            ? m(n.current_streak_range[0], y) +
                              " &ndash; " +
                              m(n.current_streak_range[1], y)
                            : n.last_contributed
                            ? "Last contributed in " +
                              m(n.last_contributed, y) +
                              "."
                            : "Rock - Hard Place"),
                          (u = n.longest_streak
                            ? m(n.longest_streak_range[0], y) +
                              " &ndash; " +
                              m(n.longest_streak_range[1], y)
                            : n.last_contributed
                            ? "Last contributed in " +
                              m(n.last_contributed, y) +
                              "."
        ...
        function (e, t, n) {
          ...
          (a.$$ = function (e, t) {
            return "string" == typeof e
              ? ((t = t || document), o(t.querySelectorAll(e)))
              : [e];
          }),
            (t.exports = a);
        },
          ...
          var r = e("months"),
            ...
            u = {
              ...
              Z: function (e) {
                ...
                return (
                  (0 <= e ? "+" : "-") + a(parseInt(e / 60)) + ":" + a(e % 60)
                );
              },
              ZZ: function (e) {
                e = -e.getTimezoneOffset();
                return (0 <= e ? "+" : "-") + a(parseInt(e / 60)) + a(e % 60);
              },
            },
            s = new e(u);
      ...
      8: [
        function (e, t, n) {
          ...
          t.exports = function (e) {
            function r() {
              o.current_streak > o.longest_streak &&
                ((o.longest_streak = o.current_streak),
                (o.longest_streak_range[0] = o.current_streak_range[0]),
                (o.longest_streak_range[1] = o.current_streak_range[1]));
            }
            var o = {
                last_year: 0,
                longest_streak: -1,
              ...
              e
                ...
                .forEach(function (e) {
                  if (e.startsWith("<g transform"))
                    return a.length && o.weeks.push(a) && (a = []);
                  ...
                  t &&
                    ...
                    0 === o.current_streak &&
                      (o.current_streak_range[0] = n.date),
                    n.count
                      ? (++o.current_streak,
                        (o.last_year += n.count),
                        (o.last_contributed = n.date),
                        (o.current_streak_range[1] = n.date))
                      : (r(), (o.current_streak = 0)),
                    a.push(n),
                    o.days.push(n));
                }),
              r(),
